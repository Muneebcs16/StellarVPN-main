...
import com.stellar.vpn.AdapterWrappers.ServerListAdapterVip;
...
public class FragmentVip extends Fragment implements ServerListAdapterVip.RegionListAdapterInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_one_dev_will, container, false);
        ...
        popupView = pInflater.inflate(R.layout.layout_bottom_sheet_will_dev, (ViewGroup) view, false);
        ...
        if (MainActivity.will_dev_33223327_all_ads_on_off && getResources().getBoolean(R.bool.facebook_list_ads) && (!Config.ads_subscription || !Config.all_subscription)) {
        } else if (MainActivity.will_dev_33223327_all_ads_on_off && getResources().getBoolean(R.bool.admob_list_ads) && (!Config.ads_subscription || !Config.all_subscription)) {

            AdmobNativeAdAdapter admobNativeAdAdapter = AdmobNativeAdAdapter.Builder
                    .with(
                            MainActivity.admob_native_id,
                            adapter,
                            "small"
                    )
                    .adItemIterval(50)
...
//        });
    ...
    public void initAdMob(View view) {
        ...
        RewardedAd.load(view.getContext(), MainActivity.will_dev_33223327_admob_reward,
