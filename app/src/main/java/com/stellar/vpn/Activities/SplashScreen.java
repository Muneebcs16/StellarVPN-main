        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try  {
                    ...
                    oneConnect.initialize(SplashScreen.this, "hoTHWnjPuuoP6cZeyDJ.3EImcUS1.NvLdt8MVxWeOJFvomjSec"); // Put Your OneConnect Api Key
                    try {
...
//        DatabaseReference will_dev_33223327_facebook_reward = database.getReference("will_dev_33223327_facebook_reward");
//        String TAG = "Firebase";
//
//
...
//                //Toast.makeText(SplashScreen.this, ""+value, Toast.LENGTH_SHORT).show();
//                try {
...
//        });
        ...
        setContentView(R.layout.activity_splash_screen_will_dev);
